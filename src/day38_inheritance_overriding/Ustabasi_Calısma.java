...
public class Ustabasi_Calısma extends Isci_Calısma{
    ...
    public static void main(String[] args) {
         ...
         */
        Ustabasi_Calısma yasin=new Ustabasi_Calısma();
         ...
         */
        Isci_Calısma ahmet= new Ustabasi_Calısma();
         ...
         */
        Personel_Calısma adem=new Ustabasi_Calısma();
